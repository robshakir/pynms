...
def beta_create_gRPCConfigOper_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  ...
  import cisco_ems_grpc_pb2
  request_serializers = {
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CliConfig'): cisco_ems_grpc_pb2.CliConfigArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CommitConfig'): cisco_ems_grpc_pb2.CommitArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CommitReplace'): cisco_ems_grpc_pb2.CommitReplaceArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'ConfigDiscardChanges'): cisco_ems_grpc_pb2.DiscardChangesArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'DeleteConfig'): cisco_ems_grpc_pb2.ConfigArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'GetConfig'): cisco_ems_grpc_pb2.ConfigGetArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'GetOper'): cisco_ems_grpc_pb2.GetOperArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'MergeConfig'): cisco_ems_grpc_pb2.ConfigArgs.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'ReplaceConfig'): cisco_ems_grpc_pb2.ConfigArgs.SerializeToString,
  }
  response_deserializers = {
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CliConfig'): cisco_ems_grpc_pb2.CliConfigReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CommitConfig'): cisco_ems_grpc_pb2.CommitReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'CommitReplace'): cisco_ems_grpc_pb2.CommitReplaceReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'ConfigDiscardChanges'): cisco_ems_grpc_pb2.DiscardChangesReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'DeleteConfig'): cisco_ems_grpc_pb2.ConfigReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'GetConfig'): cisco_ems_grpc_pb2.ConfigGetReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'GetOper'): cisco_ems_grpc_pb2.GetOperReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'MergeConfig'): cisco_ems_grpc_pb2.ConfigReply.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCConfigOper', 'ReplaceConfig'): cisco_ems_grpc_pb2.ConfigReply.FromString,
  }
  cardinalities = {
...
def beta_create_gRPCExec_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  import cisco_ems_grpc_pb2
  request_deserializers = {
    ('IOSXRExtensibleManagabilityService.gRPCExec', 'ShowCmdJSONOutput'): cisco_ems_grpc_pb2.ShowCmdArgs.FromString,
    ('IOSXRExtensibleManagabilityService.gRPCExec', 'ShowCmdTextOutput'): cisco_ems_grpc_pb2.ShowCmdArgs.FromString,
  }
  response_serializers = {
    ('IOSXRExtensibleManagabilityService.gRPCExec', 'ShowCmdJSONOutput'): cisco_ems_grpc_pb2.ShowCmdJSONReply.SerializeToString,
    ('IOSXRExtensibleManagabilityService.gRPCExec', 'ShowCmdTextOutput'): cisco_ems_grpc_pb2.ShowCmdTextReply.SerializeToString,
  }
  method_implementations = {
